...
for Idx = 1:Cfg.NrFrms
    ...
    VirtData(:,7) = DataTx2(:,4);
    VirtData(:,6) = DataTx2(:,3);
    VirtData(:,5) = DataTx2(:,1);
    VirtData(:,4) = 0.5*(DataTx2(:,2)+DataTx1(:,4));
    
    VirtData(:,3) = DataTx1(:,3);
    VirtData(:,2) = DataTx1(:,1);
    VirtData(:,1) = DataTx1(:,2);
