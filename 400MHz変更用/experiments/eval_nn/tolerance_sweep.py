"""
tolerance_sweep.py の narrow_angle_fixed 版。

変更点（3箇所のみ）:
  MODEL_PATH   : best_detector_narrow_angle.pt
  FIXED_META_CSV: learn_dataset_narrow_angle_fixed/metadata.csv
...
ax_p.grid(alpha=0.3)
ax_p.set_title(
    f"D_TOL=0, A_TOL in {{0,1}}, R_TOL=0-5  mAP={s4_mAP_avg:.4f}",
    fontsize=FP_TITLE,
)
plt.tight_layout()
...
ax_p.set_title(
    f"D_TOL=0, A_TOL in {{0,1}}, R_TOL=0-5  "
