...
評価モデル : best_detector_softmax_heatmap_single_train.pt
評価データ : single_object holdout (260件) + fixed_angle holdout (100件) = 360件
...
OUTPUT_DIR      = os.path.join(SCRIPT_DIR, "pr_curve_eval_results")
