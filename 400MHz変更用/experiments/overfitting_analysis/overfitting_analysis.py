...
OUTPUT_DIR      = os.path.join(SCRIPT_DIR, "overfitting_analysis_results")
...
plt.suptitle("Learning Curves (training loop, Dropout=ON for train)", fontsize=12)
plt.tight_layout()
...
plt.suptitle("Generalization Gap Analysis (eval mode — fair comparison)", fontsize=12)
plt.tight_layout()
